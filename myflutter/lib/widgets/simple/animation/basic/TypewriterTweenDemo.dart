...
class TypewriterTweenDemo extends StatefulWidget {
  @override
  _TypewriterTweenDemoState createState() => _TypewriterTweenDemoState();
}

class _TypewriterTweenDemoState extends State<TypewriterTweenDemo> with SingleTickerProviderStateMixin {
