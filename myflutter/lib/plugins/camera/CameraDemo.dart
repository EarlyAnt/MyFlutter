...
void logLine(String line) => print(DateTime.now().millisecondsSinceEpoch.toString() + " " + line);

void logError(String code, String message) => logLine('Error: $code\nError Message: $message');
...
class _CameraDemoState extends State<CameraDemo> with WidgetsBindingObserver {
  ...
  void waitExamAsync() async {
    ...
    await Future.any([Future.value(20), Future.delayed(const Duration(seconds: 1), () => logLine("delay2 completed"))]);
